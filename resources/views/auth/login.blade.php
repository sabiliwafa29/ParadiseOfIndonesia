<x-guest-layout>
    ...
    <div class="mt-6">
        ...
        <div class="mt-6">
            <a href="{{ route('google.login', ['return_to' => request('return_to')]) }}" class="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50">
