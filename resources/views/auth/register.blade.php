            ...
            <div class="w-full max-w-md">
                ...
                <div class="glass-card rounded-2xl p-8 lg:p-10">
                    ...
                    <div class="lg:hidden text-center mb-8">
                        ...
                        <p class="text-gray-600 text-sm">Create your account to begin</p>
                    </div>
                    ...
                    <div class="mt-8">
                        ...
                        <div class="mt-6 flex justify-center space-x-4">
                            ...
                            <a 
                                ...
                                onclick="event.preventDefault(); alert('Facebook registration coming soon!');"
                            >
                            ...
                            <a 
                                ...
                                onclick="event.preventDefault(); alert('Twitter registration coming soon!');"
                            >
