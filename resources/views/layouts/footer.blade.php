    ...
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="col-span-1">
                ...
                <ul class="space-y-3">
                    <li>
                        <a href="{{ route('home') }}" class="text-gray-400 hover:text-emerald-400 flex items-center transition-colors">
                    ...
                    <li>
                        <a href="{{ route('destinations.index') }}" class="text-gray-400 hover:text-emerald-400 flex items-center transition-colors">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <li>
                        <a href="{{ route('tour-packages.index') }}" class="text-gray-400 hover:text-emerald-400 flex items-center transition-colors">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <li>
                        <a href="{{ route('tour-sessions.index') }}" class="text-gray-400 hover:text-emerald-400 flex items-center transition-colors">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <li>
                        <a href="{{ route('travel-services.index') }}" class="text-gray-400 hover:text-emerald-400 flex items-center transition-colors">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <li>
                        <a href="{{ route('gallery.index') }}" class="text-gray-400 hover:text-emerald-400 flex items-center transition-colors">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="col-span-1">
                ...
                <ul class="space-y-4">
                    {{-- WhatsApp --}}
                    <li>
                        <a href="https://wa.me/6281585333325" target="_blank" class="flex items-start text-gray-400 hover:text-emerald-400 transition-colors group">
                            <div class="w-10 h-10 bg-gray-800 group-hover:bg-green-600 rounded-lg flex items-center justify-center mr-3 flex-shrink-0 transition-colors">
                                <svg class="w-5 h-5 text-green-400 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <div>
                                ...
                                <p class="text-sm">+62 8158 5333 325</p>
                            </div>
                        </a>
                    </li>
                    ...
                    <li>
                        <div class="flex items-start text-gray-400">
                            ...
                            <div>
                                <p class="text-sm font-medium text-white">{{ __('messages.address') }}</p>
                                <p class="text-sm">{{ __('messages.address_detail') }}</p>
                            </div>
                        </div>
                    </li>
                </ul>
            ...
            <div class="col-span-1">
                <h3 class="text-xl font-semibold mb-4 flex items-center">
                    <svg class="w-5 h-5 mr-2 text-emerald-500" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M8.691 2.188C3.891 2.188 0 5.476 0 9.53c0 2.212 1.17 4.203 3.002 5.55a.59.59 0 01.213.665l-.39 1.48c-.019.07-.048.141-.048.213 0 .163.13.295.29.295a.328.328 0 00.167-.054l1.903-1.114a.864.864 0 01.717-.098 10.16 10.16 0 002.837.403c.276 0 .543-.027.811-.05-.857-2.578.157-4.972 1.932-6.446 1.703-1.415 3.882-1.98 5.853-1.838-.576-3.583-4.196-6.348-8.596-6.348zM5.785 5.991c.642 0 1.162.529 1.162 1.18a1.17 1.17 0 01-1.162 1.178A1.17 1.17 0 014.623 7.17c0-.651.52-1.18 1.162-1.18zm5.813 0c.642 0 1.162.529 1.162 1.18a1.17 1.17 0 01-1.162 1.178 1.17 1.17 0 01-1.162-1.178c0-.651.52-1.18 1.162-1.18zm5.34 2.867c-1.797-.052-3.746.512-5.28 1.786-1.72 1.428-2.687 3.72-1.78 6.22.942 2.453 3.666 4.229 6.884 4.229.826 0 1.622-.12 2.361-.336a.722.722 0 01.598.082l1.584.926a.272.272 0 00.14.047c.134 0 .24-.111.24-.247 0-.06-.023-.12-.038-.177l-.327-1.233a.582.582 0 01-.023-.156.49.49 0 01.201-.398C23.024 18.48 24 16.82 24 14.98c0-3.21-2.931-5.837-6.656-6.088V8.89c-.135-.006-.27-.02-.406-.032zm-2.254 3.238c.535 0 .969.44.969.982a.976.976 0 01-.969.983.976.976 0 01-.969-.983c0-.542.434-.982.97-.982zm4.844 0c.535 0 .969.44.969.982a.976.976 0 01-.969.983.976.976 0 01-.969-.983c0-.542.434-.982.969-.982z"/>
                    </svg>
                    WeChat
                </h3>
