...
<div class="max-w-3xl mx-auto py-8 px-4">
    <h1 class="text-2xl font-bold mb-6">Create Special Link</h1>
    ...
    <form action="{{ route('admin.special-links.store') }}" method="POST" class="space-y-4 bg-white p-6 rounded-lg shadow">
        @csrf
        <div>
