                ...
                <form action="{{ route('admin.tours.update', $tour) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                        ...
                        <div class="p-6 grid grid-cols-2 gap-4">
                            {{-- Price (USD) --}}
                            <div>
                                <label for="price_usd" class="block text-sm font-semibold text-gray-700 mb-2">💵 Base Price (USD) *</label>
                                <div class="relative">
                                    <span class="absolute left-3 top-3 text-gray-500">$</span>
                                    <input type="number" name="price_usd" id="price_usd" value="{{ old('price_usd', $tour->price_usd ?? $tour->price ?? '') }}" required min="0" step="0.01"
                                        class="w-full pl-7 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('price_usd') border-red-500 @enderror"
                                        placeholder="0.00">
                                </div>
