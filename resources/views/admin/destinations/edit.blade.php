            ...
            <div class="flex items-center justify-between mb-6">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Update destination information and settings</p>
                    </div>
                </div>
            </div>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   name="name_zh" 
                                   value="{{ old('name_zh', $destination->name_zh) }}" 
                            ...
                            <div class="flex items-center h-12">
                                <label class="inline-flex items-center cursor-pointer">
                                    <input type="checkbox" 
                                           name="featured" 
                                           value="1" 
                                           {{ old('featured', $destination->featured) ? 'checked' : '' }}
                                           class="sr-only peer">
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="description_id" 
                                  ...
                                  placeholder="Deskripsi destinasi dalam Bahasa Indonesia...">{{ old('description_id', $destination->description_id) }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea name="description_en" 
                                  ...
                                  placeholder="Destination description in English...">{{ old('description_en', $destination->description_en) }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea name="description_zh" 
                                  ...
                                  placeholder="中文目的地描述...">{{ old('description_zh', $destination->description_zh) }}</textarea>
