...
class TourPackageController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            // These fields are stored as DECIMAL(10,2) in the DB, limit to allowed range
            'price_special_idr' => ['nullable','numeric','between:0,9999999999.99'],
            'price_special_usd' => ['nullable','numeric','between:0,9999999999.99'],
            'price_special_cny' => ['nullable','numeric','between:0,9999999999.99'],
    ...
    public function update(Request $request, TourPackage $tourPackage)
    {
        $validated = $request->validate([
            ...
            'price_cny' => 'nullable|numeric|min:0',
            // These fields are stored as DECIMAL(10,2) in the DB, limit to allowed range
            'price_special_idr' => ['nullable','numeric','between:0,99999999.99'],
            'price_special_usd' => ['nullable','numeric','between:0,99999999.99'],
            'price_special_cny' => ['nullable','numeric','between:0,99999999.99'],
            'image' => 'nullable|image|max:2048',
            'itinerary' => 'nullable|array',
            'itinerary.*.title_id' => 'required|string',
            'itinerary.*.title_en' => 'required|string',
